        ...
        <div style={{ margin: "0 0 0 2%" }}>
          ...
          <ul className="wed">
            <li>
              ...
              set up C/CD pipeline in Jenkins to prevent merging bad PRs{" "}
            </li>
            <li>
            ...
            <li>
              ...
              calls, preloading and pre-fetching. Brought down page loads from
          ...
          <ul className="wed">
            <li>
              ...
              to improve performance ( Spring Boot, JMS , AWS Aurora ){" "}, enhancing and developing  Restful APIs to support new product
              requirements
            </li>
          </ul>
        </div>
